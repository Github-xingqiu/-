...
void WorkerManager::Del_Emp()
{
	...
	else
	{
		...
		if (index != -1)	//说明职工存在，并且要删除掉index位置上的数据
		{
...
void WorkerManager::Sort_Emp()
{
	...
	else
	{
		...
		for (int i = 0; i < this->m_EmpNum; i++)
		{
			...
			//判断一开始认定 最小值或最大值 是不是计算的 最小值或最大值如果不是 交换数据
			if (i != minOrMax)
			{
